...
This code will use binary logistic regression to test feasibility of using variables plant height, canopy length, canopy width, and number of green leaves to classify whether a palmetto is species *Serenoa repens* or *Sabal etonia*.
